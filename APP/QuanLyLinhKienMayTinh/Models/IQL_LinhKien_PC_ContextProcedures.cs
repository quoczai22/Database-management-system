...
namespace QuanLyLinhKienMayTinh.Models
{
    public partial interface IQL_LinhKien_PC_ContextProcedures
    {
        ...
        Task<List<sp_kichban6_giaotaca_rollbackResult>> sp_kichban6_giaotaca_rollbackAsync(OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
